...
Uncomment last line in `docker-compose.yml` and enter the correct snapshot name and run `docker-compose up -f docker-compose.with-snapshot.yml --force-recreate`, and all data in Prometheus will be loaded from the snapshot.